...
const nodes = [
    ...
    note: [
        ...
        • Drag across the map to move around.
        • Use the scroll wheel to zoom in and out.

        <b>My synthesis theme poster is based on the two souces:</b>
        • <i>The video:</i> "I'm Not Your Inspiration, Thank You Very Much" | Stella Young
